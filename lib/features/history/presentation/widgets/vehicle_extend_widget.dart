...
class VehicleExtendWidget extends StatefulWidget {
  final Function onStateChanged;
  final String? initialValue;
  final LocationModel locationModel;

  const VehicleExtendWidget({
    super.key,
  ...
  _VehicleExtendWidgetState createState() => _VehicleExtendWidgetState();
}

class _VehicleExtendWidgetState extends State<VehicleExtendWidget> {
