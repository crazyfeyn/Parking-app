...
class _$updateProfileImpl implements _updateProfile {
  ...
  @override
  String toString() {
    return 'ProfileEvent.updateProfile(name: $name, surname: $surname, email: $email)';
  }
...
abstract class _$$addPaymentMethodImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, dynamic> paymentMethod});
}

/// @nodoc
class __$$addPaymentMethodImplCopyWithImpl<$Res>
    extends _$ProfileEventCopyWithImpl<$Res, _$addPaymentMethodImpl>
...
class _$addPaymentMethodImpl implements _addPaymentMethod {
  ...
  @override
  String toString() {
    return 'ProfileEvent.addPaymentMethod(paymentMethod: $paymentMethod)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_paymentMethod));
...
abstract class _addPaymentMethod implements ProfileEvent {
